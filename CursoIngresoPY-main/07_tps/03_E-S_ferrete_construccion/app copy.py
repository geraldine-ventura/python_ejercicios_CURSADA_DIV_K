...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        alert(
            title="mts2",
            message="El resultado total de metros cuadrados es: " + str(total_m2),
        )
        alert(
            title="mts lineales",
            message="El resultado total de metros lineales es: " + str(perimetro),
        )
        alert(
            title="cantidad quebracho",
            message="la cantidad_quebracho es: " + str(cantidad_quebracho_grueso),
        )
        alert(
            title="cantidad fino",
            message="la cantidad_quebracho fino es: " + str(cantidad_quebracho_fino),
        )
        alert(
            title="cantidad de varillas",
            message="la cantidad de varilas: " + str(cantidad_de_varillas),
        )
