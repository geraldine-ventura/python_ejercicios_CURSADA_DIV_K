...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label1 = customtkinter.CTkLabel(master=self, text="Apellido")
    ...
    def btn_mostrar_on_click(self):
        ...
        apellido=prompt(title="Ejer e/s 04", prompt="¿Cual es tu apellido?")
        mensaje=f"tu apellido es{apellido}"
        self.text_apellido.delete(0,100) 
        self.txt_apellido.insert(0,mensaje)
